...
[Guid("9E575724-617A-54E5-BF78-B6C68E5F4343")]
public partial interface IAvnNotificationCard : IAvnContentControl
{
    ...
    [PreserveSig]
    int SetIsClosed(int value);

    [PreserveSig]
    int GetNotificationType(out int value);
    ...
    [PreserveSig]
    int AdviseNotificationClosed(IAvnNotificationCardNotificationClosedHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseNotificationClosed(long subscriptionId);

}

[GeneratedComClass]
public sealed partial class AvnNotificationCard : IAvnNotificationCard
{
    private readonly global::Avalonia.Host.Ownership.ProjectionObjectState _state;
    private global::Avalonia.Controls.Notifications.NotificationCard _value => _state.GetTarget<global::Avalonia.Controls.Notifications.NotificationCard>();
    ...
    private readonly global::System.Collections.Generic.Dictionary<long, (IAvnNotificationCardNotificationClosedHandler Handler, global::System.Action Unsubscribe)> _notificationClosedSubscriptions = new();
    private long _nextNotificationClosedSubscriptionId;

    internal AvnNotificationCard(global::Avalonia.Controls.Notifications.NotificationCard value)
    {
    ...
    public int SetIsClosed(int value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.IsClosed = value != 0;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int GetNotificationType(out int value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = (int)_value.NotificationType;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetNotificationType(int value)
    {
        try
        {
            using var call = _state.EnterCall();
    ...
    public int AdviseNotificationClosed(IAvnNotificationCardNotificationClosedHandler? handler, out long subscriptionId)
    {
        subscriptionId = 0;
        if (handler is null)
            return global::Avalonia.Host.HResults.E_POINTER;
        try
        {
            ...
            eventSource.NotificationClosed += callback;
            subscriptionId = global::System.Threading.Interlocked.Increment(ref _nextNotificationClosedSubscriptionId);
            _notificationClosedSubscriptions.Add(subscriptionId, (handler, () => eventSource.NotificationClosed -= callback));
            global::Avalonia.Host.ProjectionDiagnostics.SubscriptionAdded();
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
    ...
    public int UnadviseNotificationClosed(long subscriptionId)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            if (!_notificationClosedSubscriptions.Remove(subscriptionId, out var subscription))
                return global::Avalonia.Host.HResults.E_INVALIDARG;
            subscription.Unsubscribe();
            global::Avalonia.Host.ProjectionDiagnostics.SubscriptionRemoved();
            return global::Avalonia.Host.HResults.S_OK;
    ...
    private void ReleaseSubscriptions()
    {
        ...
        foreach (var subscription in _notificationClosedSubscriptions.Values)
        {
            subscription.Unsubscribe();
            global::Avalonia.Host.ProjectionDiagnostics.SubscriptionRemoved();
        }
        _notificationClosedSubscriptions.Clear();
    }
}
