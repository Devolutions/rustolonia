...
[Guid("9B09B01F-E387-5C6F-BB9B-605FC43BA233")]
public partial interface IAvnShape : IAvnControl
{
    [PreserveSig]
    int GetFill(out IAvnBrush? value);

    [PreserveSig]
    int SetFill(IAvnBrush? value);
    ...
    [PreserveSig]
    int GetStroke(out IAvnBrush? value);

    [PreserveSig]
    int SetStroke(IAvnBrush? value);

    [PreserveSig]
    int GetStrokeDashArray(out string? value);

    [PreserveSig]
    int SetStrokeDashArray(string? value);

    [PreserveSig]
    int GetStrokeDashOffset(out double value);

    [PreserveSig]
    int SetStrokeDashOffset(double value);

    [PreserveSig]
    int GetStrokeThickness(out double value);

    [PreserveSig]
    int SetStrokeThickness(double value);

    [PreserveSig]
    int GetStrokeLineCap(out int value);

    [PreserveSig]
    int SetStrokeLineCap(int value);

    [PreserveSig]
    int GetStrokeJoin(out int value);

    [PreserveSig]
    int SetStrokeJoin(int value);

    [PreserveSig]
    int GetStrokeMiterLimit(out double value);

    [PreserveSig]
    int SetStrokeMiterLimit(double value);

}

[GeneratedComClass]
public sealed partial class AvnShape : IAvnShape
{
    private readonly global::Avalonia.Host.Ownership.ProjectionObjectState _state;
    private global::Avalonia.Controls.Shapes.Shape _value => _state.GetTarget<global::Avalonia.Controls.Shapes.Shape>();
    ...
    internal AvnShape(global::Avalonia.Controls.Shapes.Shape value)
    {
