...
[Guid("1E92B6FA-9790-5135-8AC6-A566A0EAD414")]
public partial interface IAvnMenuBase : IAvnSelectingItemsControl
{
    ...
    [PreserveSig]
    int AdviseOpened(IAvnMenuBaseOpenedHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseOpened(long subscriptionId);

    [PreserveSig]
    int AdviseClosed(IAvnMenuBaseClosedHandler? handler, out long subscriptionId);
...
[GeneratedComClass]
public sealed partial class AvnMenuBase : IAvnMenuBase
{
    private readonly global::Avalonia.Host.Ownership.ProjectionObjectState _state;
    private global::Avalonia.Controls.MenuBase _value => _state.GetTarget<global::Avalonia.Controls.MenuBase>();
    ...
    internal AvnMenuBase(global::Avalonia.Controls.MenuBase value)
    {
