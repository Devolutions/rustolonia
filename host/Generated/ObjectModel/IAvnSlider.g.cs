...
[Guid("BF042391-AF5A-5DD4-B321-055CA9F70D23")]
public partial interface IAvnSlider : IAvnRangeBase
{
    [PreserveSig]
    int GetTicks(out string? value);

    [PreserveSig]
    int SetTicks(string? value);
...
public sealed partial class AvnSlider : IAvnSlider
{
    ...
    public int AdviseValueChanged(IAvnRangeBaseValueChangedHandler? handler, out long subscriptionId)
    {
        ...
        try
        {
            ...
            {
                var hr = handler.Invoke(eventArgs.OldValue, eventArgs.NewValue);
                if (hr < 0)
                    global::System.Runtime.InteropServices.Marshal.ThrowExceptionForHR(hr);
            });
    ...
    public int GetTicks(out string? value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = global::Avalonia.Host.Com.AvnDoubleList.ToAbi(_value.Ticks);
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetTicks(string? value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.Ticks = global::Avalonia.Host.Com.AvnDoubleList.FromAbi(value);
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
