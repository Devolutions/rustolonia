...
[Guid("95707491-9943-5B6C-BF2E-1A68A797A842")]
public partial interface IAvnRefreshContainer : IAvnContentControl
{
    [PreserveSig]
    int GetIsMouseEnabled(out int value);

    [PreserveSig]
    int SetIsMouseEnabled(int value);

    [PreserveSig]
    int GetPullDirection(out int value);
...
[GeneratedComClass]
public sealed partial class AvnRefreshContainer : IAvnRefreshContainer
{
    private readonly global::Avalonia.Host.Ownership.ProjectionObjectState _state;
    private global::Avalonia.Controls.RefreshContainer _value => _state.GetTarget<global::Avalonia.Controls.RefreshContainer>();
    ...
    public int GetIsMouseEnabled(out int value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = _value.IsMouseEnabled ? 1 : 0;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetIsMouseEnabled(int value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.IsMouseEnabled = value != 0;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int GetPullDirection(out int value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = (int)_value.PullDirection;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetPullDirection(int value)
    {
        try
        {
            using var call = _state.EnterCall();
