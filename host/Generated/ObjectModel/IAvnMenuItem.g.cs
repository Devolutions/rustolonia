...
[Guid("15CE4E5D-E0E7-5356-ACFF-D742B7280B97")]
public partial interface IAvnMenuItem : IAvnHeaderedSelectingItemsControl
{
    ...
    [PreserveSig]
    int GetIsSubMenuOpen(out int value);

    [PreserveSig]
    int SetIsSubMenuOpen(int value);

    [PreserveSig]
    int GetStaysOpenOnClick(out int value);

    [PreserveSig]
    int SetStaysOpenOnClick(int value);

    [PreserveSig]
    int GetToggleType(out int value);

    [PreserveSig]
    int SetToggleType(int value);
    ...
    [PreserveSig]
    int AdviseSubmenuOpened(IAvnMenuItemSubmenuOpenedHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseSubmenuOpened(long subscriptionId);

}

[GeneratedComClass]
public sealed partial class AvnMenuItem : IAvnMenuItem
{
    private readonly global::Avalonia.Host.Ownership.ProjectionObjectState _state;
    private global::Avalonia.Controls.MenuItem _value => _state.GetTarget<global::Avalonia.Controls.MenuItem>();
    ...
    private readonly global::System.Collections.Generic.Dictionary<long, (IAvnMenuItemClickHandler Handler, global::System.Action Unsubscribe)> _clickSubscriptions = new();
    private long _nextClickSubscriptionId;
    private readonly global::System.Collections.Generic.Dictionary<long, (IAvnMenuItemSubmenuOpenedHandler Handler, global::System.Action Unsubscribe)> _submenuOpenedSubscriptions = new();
    private long _nextSubmenuOpenedSubscriptionId;

    internal AvnMenuItem(global::Avalonia.Controls.MenuItem value)
    {
    ...
    public int GetSelectedValue(out AvnVariant value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = AvnVariant.FromObject(_value.SelectedValue);
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetSelectedValue(AvnVariant value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.SelectedValue = value.ToObject();
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int GetIcon(out IAvnControl? value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = (IAvnControl?)ProjectionRuntime.Wrap(_value.Icon as global::Avalonia.AvaloniaObject);
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetIcon(IAvnControl? value)
    {
        try
        {
            using var call = _state.EnterCall();
    ...
    public int GetIsSubMenuOpen(out int value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = _value.IsSubMenuOpen ? 1 : 0;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetIsSubMenuOpen(int value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.IsSubMenuOpen = value != 0;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int GetStaysOpenOnClick(out int value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = _value.StaysOpenOnClick ? 1 : 0;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetStaysOpenOnClick(int value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.StaysOpenOnClick = value != 0;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int GetToggleType(out int value)
    {
        value = default;
        try
        {
    ...
    public int SetToggleType(int value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.ToggleType = (global::Avalonia.Controls.MenuItemToggleType)value;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int AdviseClick(IAvnMenuItemClickHandler? handler, out long subscriptionId)
    {
        subscriptionId = 0;
        if (handler is null)
            return global::Avalonia.Host.HResults.E_POINTER;
    ...
    public int AdviseSubmenuOpened(IAvnMenuItemSubmenuOpenedHandler? handler, out long subscriptionId)
    {
        subscriptionId = 0;
        if (handler is null)
            return global::Avalonia.Host.HResults.E_POINTER;
        try
        {
            ...
            eventSource.SubmenuOpened += callback;
            subscriptionId = global::System.Threading.Interlocked.Increment(ref _nextSubmenuOpenedSubscriptionId);
            _submenuOpenedSubscriptions.Add(subscriptionId, (handler, () => eventSource.SubmenuOpened -= callback));
            global::Avalonia.Host.ProjectionDiagnostics.SubscriptionAdded();
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
    ...
    public int UnadviseSubmenuOpened(long subscriptionId)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            if (!_submenuOpenedSubscriptions.Remove(subscriptionId, out var subscription))
                return global::Avalonia.Host.HResults.E_INVALIDARG;
            subscription.Unsubscribe();
            global::Avalonia.Host.ProjectionDiagnostics.SubscriptionRemoved();
            return global::Avalonia.Host.HResults.S_OK;
    ...
    private void ReleaseSubscriptions()
    {
        ...
        foreach (var subscription in _submenuOpenedSubscriptions.Values)
        {
            subscription.Unsubscribe();
            global::Avalonia.Host.ProjectionDiagnostics.SubscriptionRemoved();
        }
        _submenuOpenedSubscriptions.Clear();
    }
}
