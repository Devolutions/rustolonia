...
[Guid("E465D453-88D0-5CD1-AF2C-389B5D80BE4D")]
public partial interface IAvnThumb : IAvnTemplatedControl
{
    [PreserveSig]
    int AdviseDragStarted(IAvnThumbDragStartedHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseDragStarted(long subscriptionId);

    [PreserveSig]
    int AdviseDragDelta(IAvnThumbDragDeltaHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseDragDelta(long subscriptionId);

    [PreserveSig]
    int AdviseDragCompleted(IAvnThumbDragCompletedHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseDragCompleted(long subscriptionId);

}

[GeneratedComClass]
public sealed partial class AvnThumb : IAvnThumb
{
    private readonly global::Avalonia.Host.Ownership.ProjectionObjectState _state;
    private global::Avalonia.Controls.Primitives.Thumb _value => _state.GetTarget<global::Avalonia.Controls.Primitives.Thumb>();
    ...
    internal AvnThumb(global::Avalonia.Controls.Primitives.Thumb value)
    {
