...
[Guid("6E80826C-F337-5A4D-A5BB-1C0DF436B6D0")]
public partial interface IAvnTemplatedControl : IAvnControl
{
    ...
    [PreserveSig]
    int SetBorderBrush(IAvnBrush? value);

    [PreserveSig]
    int GetBorderThickness(out AvnThickness value);

    [PreserveSig]
    int SetBorderThickness(AvnThickness value);

    [PreserveSig]
    int GetCornerRadius(out AvnCornerRadius value);
...
public sealed partial class AvnTemplatedControl : IAvnTemplatedControl
{
    ...
    private global::Avalonia.Controls.Primitives.TemplatedControl _value => _state.GetTarget<global::Avalonia.Controls.Primitives.TemplatedControl>();
