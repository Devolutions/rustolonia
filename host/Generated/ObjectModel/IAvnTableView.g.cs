...
[Guid("D4BE6E5C-B5DD-5BB0-A30F-3CC833767F7C")]
public partial interface IAvnTableView : IAvnListBox
{
    ...
    [PreserveSig]
    int SetCanUserResizeColumns(int value);

}

[GeneratedComClass]
public sealed partial class AvnTableView : IAvnTableView
{
    private readonly global::Avalonia.Host.Ownership.ProjectionObjectState _state;
    private global::Avalonia.Controls.TableView _value => _state.GetTarget<global::Avalonia.Controls.TableView>();
    ...
    public int GetCanUserResizeColumns(out int value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = _value.CanUserResizeColumns ? 1 : 0;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetCanUserResizeColumns(int value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.CanUserResizeColumns = value != 0;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
