...
[Guid("643AACDC-AB53-56DF-A197-28042BF4D69F")]
public partial interface IAvnTransitioningContentControl : IAvnContentControl
{
    [PreserveSig]
    int GetIsTransitionReversed(out int value);
...
[GeneratedComClass]
public sealed partial class AvnTransitioningContentControl : IAvnTransitioningContentControl
{
    private readonly global::Avalonia.Host.Ownership.ProjectionObjectState _state;
    private global::Avalonia.Controls.TransitioningContentControl _value => _state.GetTarget<global::Avalonia.Controls.TransitioningContentControl>();
    ...
    public int GetIsTransitionReversed(out int value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = _value.IsTransitionReversed ? 1 : 0;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetIsTransitionReversed(int value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.IsTransitionReversed = value != 0;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
