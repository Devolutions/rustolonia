...
[Guid("B496C390-157D-54E1-8415-E487E93DAF7D")]
public partial interface IAvnCarousel : IAvnSelectingItemsControl
{
    [PreserveSig]
    int GetIsSwipeEnabled(out int value);

    [PreserveSig]
    int SetIsSwipeEnabled(int value);

    [PreserveSig]
    int GetViewportFraction(out double value);

    [PreserveSig]
    int SetViewportFraction(double value);
...
[GeneratedComClass]
public sealed partial class AvnCarousel : IAvnCarousel
{
    private readonly global::Avalonia.Host.Ownership.ProjectionObjectState _state;
    private global::Avalonia.Controls.Carousel _value => _state.GetTarget<global::Avalonia.Controls.Carousel>();
    ...
    internal AvnCarousel(global::Avalonia.Controls.Carousel value)
    {
    ...
    public int GetIsSwipeEnabled(out int value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = _value.IsSwipeEnabled ? 1 : 0;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetIsSwipeEnabled(int value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.IsSwipeEnabled = value != 0;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int GetViewportFraction(out double value)
    {
        value = default;
        try
        {
    ...
    public int SetViewportFraction(double value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.ViewportFraction = value;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int GetIsSwiping(out int value)
    {
        value = default;
        try
        {
