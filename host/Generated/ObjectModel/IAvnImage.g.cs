...
[Guid("4A556F2B-827F-5748-B7CD-C48452727A29")]
public partial interface IAvnImage : IAvnControl
{
    [PreserveSig]
    int GetSource(out string? value);

    [PreserveSig]
    int SetSource(string? value);

    [PreserveSig]
    int GetBlendMode(out int value);

    [PreserveSig]
    int SetBlendMode(int value);

    [PreserveSig]
    int GetStretch(out int value);

    [PreserveSig]
    int SetStretch(int value);

    [PreserveSig]
    int GetStretchDirection(out int value);

    [PreserveSig]
    int SetStretchDirection(int value);

}

[GeneratedComClass]
public sealed partial class AvnImage : IAvnImage
{
    private readonly global::Avalonia.Host.Ownership.ProjectionObjectState _state;
    private global::Avalonia.Controls.Image _value => _state.GetTarget<global::Avalonia.Controls.Image>();
    ...
    internal AvnImage(global::Avalonia.Controls.Image value)
    {
    ...
    public int GetSource(out string? value)
    {
        value = default;
        try
        {
    ...
    public int SetSource(string? value)
    {
        try
        {
            using var call = _state.EnterCall();
    ...
    public int GetBlendMode(out int value)
    {
        value = default;
        try
        {
    ...
    public int SetBlendMode(int value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.BlendMode = (global::Avalonia.Media.Imaging.BitmapBlendingMode)value;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int GetStretchDirection(out int value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = (int)_value.StretchDirection;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetStretchDirection(int value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.StretchDirection = (global::Avalonia.Media.StretchDirection)value;
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
