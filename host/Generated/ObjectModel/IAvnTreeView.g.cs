...
[Guid("0B60003F-EC3F-5F72-9763-04C3C4FFE8DD")]
public partial interface IAvnTreeView : IAvnItemsControl
{
    [PreserveSig]
    int GetAutoScrollToSelectedItem(out int value);

    [PreserveSig]
    int SetAutoScrollToSelectedItem(int value);
    ...
    [PreserveSig]
    int CollapseSubTreeWithTreeViewItem(IAvnTreeViewItem? item);
...
[GeneratedComClass]
public sealed partial class AvnTreeView : IAvnTreeView
{
    private readonly global::Avalonia.Host.Ownership.ProjectionObjectState _state;
    private global::Avalonia.Controls.TreeView _value => _state.GetTarget<global::Avalonia.Controls.TreeView>();
    ...
    private readonly global::System.Collections.Generic.Dictionary<long, (IAvnTreeViewSelectionChangedHandler Handler, global::System.Action Unsubscribe)> _selectionChangedSubscriptions = new();
    private long _nextSelectionChangedSubscriptionId;

    internal AvnTreeView(global::Avalonia.Controls.TreeView value)
    {
    ...
    public int CollapseSubTreeWithTreeViewItem(IAvnTreeViewItem? item)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.CollapseSubTree((global::Avalonia.Controls.TreeViewItem)ProjectionRuntime.Unwrap(item)!);
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int AdviseSelectionChanged(IAvnTreeViewSelectionChangedHandler? handler, out long subscriptionId)
    {
        subscriptionId = 0;
        if (handler is null)
            return global::Avalonia.Host.HResults.E_POINTER;
        try
        {
            ...
            {
                var args = new AvnTreeViewSelectionChangedArgs(new global::System.Collections.IEnumerable?[]
