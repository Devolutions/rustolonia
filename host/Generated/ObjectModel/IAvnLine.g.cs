...
[Guid("E432CA0E-417D-584A-A0AB-884ACB73A6F6")]
public partial interface IAvnLine : IAvnShape
{
    [PreserveSig]
    int GetStartPoint(out AvnPoint value);

    [PreserveSig]
    int SetStartPoint(AvnPoint value);

    [PreserveSig]
    int GetEndPoint(out AvnPoint value);

    [PreserveSig]
    int SetEndPoint(AvnPoint value);

}

[GeneratedComClass]
public sealed partial class AvnLine : IAvnLine
{
    private readonly global::Avalonia.Host.Ownership.ProjectionObjectState _state;
    private global::Avalonia.Controls.Shapes.Line _value => _state.GetTarget<global::Avalonia.Controls.Shapes.Line>();
    ...
    internal AvnLine(global::Avalonia.Controls.Shapes.Line value)
    {
    ...
    public int GetStartPoint(out AvnPoint value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = AvnPoint.FromAvalonia(_value.StartPoint);
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetStartPoint(AvnPoint value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.StartPoint = value.ToAvalonia();
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int GetEndPoint(out AvnPoint value)
    {
        value = default;
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            value = AvnPoint.FromAvalonia(_value.EndPoint);
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
    ...
    public int SetEndPoint(AvnPoint value)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            _value.EndPoint = value.ToAvalonia();
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
        {
