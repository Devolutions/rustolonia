...
public partial interface IAvnControl : IAvnStyledElement
{
    ...
    [PreserveSig]
    int GetContextMenu(out IAvnContextMenu? value);

    [PreserveSig]
    int SetContextMenu(IAvnContextMenu? value);

    [PreserveSig]
    int GetContextFlyout(out IAvnFlyoutBase? value);

    [PreserveSig]
    int SetContextFlyout(IAvnFlyoutBase? value);

    [PreserveSig]
    int GetIsLoaded(out int value);

    [PreserveSig]
    int GetTag(out AvnVariant value);

    [PreserveSig]
    int SetTag(AvnVariant value);
    ...
    [PreserveSig]
    int GetMinHeight(out double value);

    [PreserveSig]
    int SetMinHeight(double value);

    [PreserveSig]
    int GetMaxHeight(out double value);

    [PreserveSig]
    int SetMaxHeight(double value);

    [PreserveSig]
    int GetMargin(out AvnThickness value);

    [PreserveSig]
    int SetMargin(AvnThickness value);

    [PreserveSig]
    int GetHorizontalAlignment(out int value);

    [PreserveSig]
    int SetHorizontalAlignment(int value);

    [PreserveSig]
    int GetVerticalAlignment(out int value);
    ...
    [PreserveSig]
    int UnadviseLoaded(long subscriptionId);

    [PreserveSig]
    int AdviseUnloaded(IAvnControlUnloadedHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseUnloaded(long subscriptionId);

    [PreserveSig]
    int AdviseSizeChanged(IAvnControlSizeChangedHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseSizeChanged(long subscriptionId);

    [PreserveSig]
    int AdviseGotFocus(IAvnControlGotFocusHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseGotFocus(long subscriptionId);

    [PreserveSig]
    int AdviseLostFocus(IAvnControlLostFocusHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseLostFocus(long subscriptionId);
    ...
    [PreserveSig]
    int AdviseKeyUp(IAvnControlKeyUpHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseKeyUp(long subscriptionId);
    ...
    [PreserveSig]
    int AdvisePointerWheelChanged(IAvnControlPointerWheelChangedHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadvisePointerWheelChanged(long subscriptionId);

    [PreserveSig]
    int AdviseTapped(IAvnControlTappedHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseTapped(long subscriptionId);

    [PreserveSig]
    int AdviseDoubleTapped(IAvnControlDoubleTappedHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseDoubleTapped(long subscriptionId);
...
public sealed partial class AvnControl : IAvnControl
{
    ...
    private global::Avalonia.Controls.Control _value => _state.GetTarget<global::Avalonia.Controls.Control>();
