...
[Guid("F173219D-C63C-5669-BE7D-98E98BF1C54B")]
public partial interface IAvnTreeViewItem : IAvnHeaderedItemsControl
{
    ...
    [PreserveSig]
    int GetLevel(out int value);

    [PreserveSig]
    int AdviseExpanded(IAvnTreeViewItemExpandedHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseExpanded(long subscriptionId);

    [PreserveSig]
    int AdviseCollapsed(IAvnTreeViewItemCollapsedHandler? handler, out long subscriptionId);
...
[GeneratedComClass]
public sealed partial class AvnTreeViewItem : IAvnTreeViewItem
{
    private readonly global::Avalonia.Host.Ownership.ProjectionObjectState _state;
    private global::Avalonia.Controls.TreeViewItem _value => _state.GetTarget<global::Avalonia.Controls.TreeViewItem>();
    ...
    private readonly global::System.Collections.Generic.Dictionary<long, (IAvnTreeViewItemExpandedHandler Handler, global::System.Action Unsubscribe)> _expandedSubscriptions = new();
    private long _nextExpandedSubscriptionId;
    private readonly global::System.Collections.Generic.Dictionary<long, (IAvnTreeViewItemCollapsedHandler Handler, global::System.Action Unsubscribe)> _collapsedSubscriptions = new();
    private long _nextCollapsedSubscriptionId;

    internal AvnTreeViewItem(global::Avalonia.Controls.TreeViewItem value)
    {
    ...
    public int GetLevel(out int value)
    {
        value = default;
        try
        {
    ...
    public int AdviseExpanded(IAvnTreeViewItemExpandedHandler? handler, out long subscriptionId)
    {
        subscriptionId = 0;
        if (handler is null)
            return global::Avalonia.Host.HResults.E_POINTER;
    ...
    public int AdviseCollapsed(IAvnTreeViewItemCollapsedHandler? handler, out long subscriptionId)
    {
        subscriptionId = 0;
        if (handler is null)
            return global::Avalonia.Host.HResults.E_POINTER;
