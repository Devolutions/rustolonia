...
[Guid("63426B0F-1A76-51A9-9E98-343D2E69C156")]
public partial interface IAvnNumericUpDown : IAvnTemplatedControl
{
    ...
    [PreserveSig]
    int AdviseSpinned(IAvnNumericUpDownSpinnedHandler? handler, out long subscriptionId);

    [PreserveSig]
    int UnadviseSpinned(long subscriptionId);
...
public sealed partial class AvnNumericUpDown : IAvnNumericUpDown
{
    ...
    private readonly global::System.Collections.Generic.Dictionary<long, (IAvnNumericUpDownSpinnedHandler Handler, global::System.Action Unsubscribe)> _spinnedSubscriptions = new();
    private long _nextSpinnedSubscriptionId;
    ...
    public int AdviseSpinned(IAvnNumericUpDownSpinnedHandler? handler, out long subscriptionId)
    {
        subscriptionId = 0;
        if (handler is null)
            return global::Avalonia.Host.HResults.E_POINTER;
        try
        {
            ...
            eventSource.Spinned += callback;
            subscriptionId = global::System.Threading.Interlocked.Increment(ref _nextSpinnedSubscriptionId);
            _spinnedSubscriptions.Add(subscriptionId, (handler, () => eventSource.Spinned -= callback));
            global::Avalonia.Host.ProjectionDiagnostics.SubscriptionAdded();
            return global::Avalonia.Host.HResults.S_OK;
        }
        catch (global::System.Exception e)
    ...
    public int UnadviseSpinned(long subscriptionId)
    {
        try
        {
            using var call = _state.EnterCall();
            _value.VerifyAccess();
            if (!_spinnedSubscriptions.Remove(subscriptionId, out var subscription))
                return global::Avalonia.Host.HResults.E_INVALIDARG;
            subscription.Unsubscribe();
            global::Avalonia.Host.ProjectionDiagnostics.SubscriptionRemoved();
            return global::Avalonia.Host.HResults.S_OK;
    ...
    private void ReleaseSubscriptions()
    {
        ...
        foreach (var subscription in _spinnedSubscriptions.Values)
        {
            subscription.Unsubscribe();
            global::Avalonia.Host.ProjectionDiagnostics.SubscriptionRemoved();
        }
        _spinnedSubscriptions.Clear();
