...
public static class AvaloniaProjectionProfiles
{
    public static ProjectionPolicy ObjectModelKernel { get; } = new()
    {
        ...
        AbiVersions = new Dictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            ["Avalonia.Host.Com.IAvnControl"] = 10,
            ["Avalonia.Host.Com.IAvnDecorator"] = 12,
            ...
            ["Avalonia.Host.Com.IAvnBorder"] = 14,
            ["Avalonia.Host.Com.IAvnTableViewColumn"] = 7,
            ["Avalonia.Host.Com.IAvnPanel"] = 13,
            ["Avalonia.Host.Com.IAvnCanvas"] = 13,
            ["Avalonia.Host.Com.IAvnDockPanel"] = 13,
            ["Avalonia.Host.Com.IAvnStackPanel"] = 14,
            ...
            ["Avalonia.Host.Com.IAvnTextBlock"] = 16,
            ["Avalonia.Host.Com.IAvnSelectableTextBlock"] = 13,
            ["Avalonia.Host.Com.IAvnTemplatedControl"] = 14,
            ["Avalonia.Host.Com.IAvnItemsControl"] = 17,
            ["Avalonia.Host.Com.IAvnSelectingItemsControl"] = 17,
            ["Avalonia.Host.Com.IAvnTextBox"] = 20,
            ["Avalonia.Host.Com.IAvnRangeBase"] = 14,
            ["Avalonia.Host.Com.IAvnSlider"] = 14,
            ["Avalonia.Host.Com.IAvnProgressBar"] = 15,
            ["Avalonia.Host.Com.IAvnContentControl"] = 15,
            ["Avalonia.Host.Com.IAvnHeaderedContentControl"] = 15,
            ["Avalonia.Host.Com.IAvnExpander"] = 15,
            ["Avalonia.Host.Com.IAvnButton"] = 18,
            ["Avalonia.Host.Com.IAvnToggleButton"] = 18,
            ["Avalonia.Host.Com.IAvnCheckBox"] = 18,
            ["Avalonia.Host.Com.IAvnRadioButton"] = 18,
            ["Avalonia.Host.Com.IAvnToggleSwitch"] = 18,
            ["Avalonia.Host.Com.IAvnListBox"] = 18,
            ["Avalonia.Host.Com.IAvnComboBox"] = 19,
            ["Avalonia.Host.Com.IAvnListBoxItem"] = 17,
            ["Avalonia.Host.Com.IAvnComboBoxItem"] = 17,
            ["Avalonia.Host.Com.IAvnScrollViewer"] = 17,
            ["Avalonia.Host.Com.IAvnWindow"] = 20,
            ["Avalonia.Host.Com.IAvnGrid"] = 14,
            // Previously version-1 templated types inherit the TemplatedControl bump.
            ["Avalonia.Host.Com.IAvnAutoCompleteBox"] = 18,
            ["Avalonia.Host.Com.IAvnButtonSpinner"] = 11,
            ["Avalonia.Host.Com.IAvnCalendar"] = 14,
            ["Avalonia.Host.Com.IAvnCalendarDatePicker"] = 13,
            ["Avalonia.Host.Com.IAvnCarousel"] = 15,
            ["Avalonia.Host.Com.IAvnCommandBar"] = 14,
            ["Avalonia.Host.Com.IAvnCommand"] = 2,
            ["Avalonia.Host.Com.IAvnCommandBarButton"] = 13,
            ["Avalonia.Host.Com.IAvnCommandBarSeparator"] = 11,
            ["Avalonia.Host.Com.IAvnCommandBarToggleButton"] = 13,
            ["Avalonia.Host.Com.IAvnContextMenu"] = 17,
            ["Avalonia.Host.Com.IAvnPopup"] = 10,
            ...
            ["Avalonia.Host.Com.IAvnDatePicker"] = 13,
            ["Avalonia.Host.Com.IAvnDropDownButton"] = 13,
            ["Avalonia.Host.Com.IAvnGridSplitter"] = 12,
            ["Avalonia.Host.Com.IAvnGroupBox"] = 11,
            ["Avalonia.Host.Com.IAvnHeaderedItemsControl"] = 14,
            ["Avalonia.Host.Com.IAvnHeaderedSelectingItemsControl"] = 14,
            ["Avalonia.Host.Com.IAvnHyperlinkButton"] = 13,
            ["Avalonia.Host.Com.IAvnIconElement"] = 11,
            ["Avalonia.Host.Com.IAvnLabel"] = 12,
            ["Avalonia.Host.Com.IAvnMaskedTextBox"] = 17,
            ["Avalonia.Host.Com.IAvnMenu"] = 14,
            ["Avalonia.Host.Com.IAvnMenuBase"] = 14,
            ["Avalonia.Host.Com.IAvnMenuItem"] = 17,
            ["Avalonia.Host.Com.IAvnNotificationCard"] = 12,
            ["Avalonia.Host.Com.IAvnNumericUpDown"] = 12,
            ["Avalonia.Host.Com.IAvnPathIcon"] = 11,
            ["Avalonia.Host.Com.IAvnPipsPager"] = 12,
            ["Avalonia.Host.Com.IAvnRefreshContainer"] = 12,
            ["Avalonia.Host.Com.IAvnRepeatButton"] = 13,
            ["Avalonia.Host.Com.IAvnSeparator"] = 11,
            ["Avalonia.Host.Com.IAvnSpinner"] = 11,
            ["Avalonia.Host.Com.IAvnSplitButton"] = 14,
            ["Avalonia.Host.Com.IAvnSplitView"] = 11,
            ["Avalonia.Host.Com.IAvnTabControl"] = 14,
            ["Avalonia.Host.Com.IAvnTabItem"] = 13,
            ["Avalonia.Host.Com.IAvnTableView"] = 15,
            ["Avalonia.Host.Com.IAvnTableViewCell"] = 13,
            ["Avalonia.Host.Com.IAvnTableViewRow"] = 11,
            ["Avalonia.Host.Com.IAvnThumb"] = 12,
            ["Avalonia.Host.Com.IAvnTimePicker"] = 13,
            ["Avalonia.Host.Com.IAvnToggleSplitButton"] = 14,
            ["Avalonia.Host.Com.IAvnToolTip"] = 11,
            ["Avalonia.Host.Com.IAvnTransitioningContentControl"] = 12,
            ["Avalonia.Host.Com.IAvnTreeView"] = 14,
            ["Avalonia.Host.Com.IAvnTreeViewItem"] = 14,
            ["Avalonia.Host.Com.IAvnUserControl"] = 11,
            ["Avalonia.Host.Com.IAvnWindowNotificationManager"] = 12,
            ...
            ["Avalonia.Host.Com.IAvnImage"] = 10,
            ["Avalonia.Host.Com.IAvnWrapPanel"] = 10,
            ["Avalonia.Host.Com.IAvnUniformGrid"] = 10,
            ["Avalonia.Host.Com.IAvnRelativePanel"] = 10,
            ["Avalonia.Host.Com.IAvnViewbox"] = 10,
            ["Avalonia.Host.Com.IAvnFlexPanel"] = 10,
            ["Avalonia.Host.Com.IAvnShape"] = 10,
            ["Avalonia.Host.Com.IAvnRectangle"] = 10,
            ["Avalonia.Host.Com.IAvnEllipse"] = 10,
            ["Avalonia.Host.Com.IAvnLine"] = 10,
            ["Avalonia.Host.Com.IAvnPath"] = 10,
            ["Avalonia.Host.Com.IAvnPolygon"] = 10,
            ["Avalonia.Host.Com.IAvnPolyline"] = 10,
            ["Avalonia.Host.Com.IAvnArc"] = 10,
            ["Avalonia.Host.Com.IAvnSector"] = 10,
            ["Avalonia.Host.Com.IAvnLayoutTransformControl"] = 10,
            ["Avalonia.Host.Com.IAvnThemeVariantScope"] = 10,
            ...
            // keep their signatures; the controls themselves republish only because
            // Control gained KeyUp/GotFocus/LostFocus.
        ...
        IncludeMembers = new Dictionary<string, IReadOnlyList<string>>(StringComparer.Ordinal)
        {
            ...
            [
                ...
                "Opacity", "IsEnabled", "KeyDown", "KeyUp", "GotFocus", "LostFocus",
                "PointerEntered", "PointerExited", "Tapped", "DoubleTapped",
                "PointerWheelChanged",
                    ...
                    EventOverrides = new Dictionary<string, EventProjection>(StringComparer.Ordinal)
        {
            ...
            // Wave P: RangeBaseValueChangedEventArgs carries the old/new double pair.
            ["Avalonia.Controls.Primitives.RangeBase.ValueChanged"] = new()
            {
                PayloadKind = EventPayloadKind.Fields,
                Parameters = [new() { Name = "OldValue" }, new() { Name = "NewValue" }],
            },
            ...
            // Wave P: SelectionChangedEventArgs carries the added/removed item lists,
            // which cross as Variant slots on the host-implemented args interface.
            ...
            // rather than the SelectingItemsControl one. Same SelectionChangedEventArgs shape.
            ...
            // Wave P: KeyUp mirrors KeyDown; GotFocus carries the navigation context;
            // LostFocusEventArgs has no payload members, so it crosses as a notification.
            ["Avalonia.Controls.Control.KeyUp"] = new()
            {
                PayloadKind = EventPayloadKind.Fields,
                Parameters =
                [
            ...
            ["Avalonia.Controls.Control.GotFocus"] = new()
            {
                PayloadKind = EventPayloadKind.Fields,
                Parameters =
                [
                    new() { Name = "NavigationMethod" },
                    new() { Name = "KeyModifiers" },
                ],
            },
            ["Avalonia.Controls.Control.LostFocus"] = new()
            {
                PayloadKind = EventPayloadKind.None,
            },
            // Wave Q: PointerEventArgs is a routed-event args type whose host-typed members
            // (IPointer, the relative position) stay off the wire; the device-independent
            // scalars cross as fields.
            ["Avalonia.Controls.Control.PointerEntered"] = new()
            {
                PayloadKind = EventPayloadKind.Fields,
                Parameters = [new() { Name = "KeyModifiers" }],
            },
            ...
            // Wave Q: TappedEventArgs carries the tap as a KeyModifiers field. DoubleTapped
            // has no payload members of its own, so it crosses as a notification.
            ["Avalonia.Controls.Control.Tapped"] = new()
            {
                PayloadKind = EventPayloadKind.Fields,
                Parameters = [new() { Name = "KeyModifiers" }],
            },
            ["Avalonia.Controls.Control.DoubleTapped"] = new()
            {
                PayloadKind = EventPayloadKind.None,
            },
            // Wave Q: PointerWheelEventArgs carries the scroll delta as an AvnVector and
            // the modifiers at the time of the wheel tick.
            ["Avalonia.Controls.Control.PointerWheelChanged"] = new()
            {
                PayloadKind = EventPayloadKind.Fields,
                Parameters =
                [
