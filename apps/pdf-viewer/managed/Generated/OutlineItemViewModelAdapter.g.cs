...
[GeneratedComClass]
public sealed partial class OutlineItemViewModelAdapter : IAvnRustVmSink, IAvnRustVmSink2, IAvnRustVmSink3, IRustVmStringSnapshotSink, IRustVmModelSnapshotSink, IRustVmBatchTarget, IRustVmTableSelectionBatchTarget, INotifyPropertyChanged, INotifyDataErrorInfo, IDisposable
{
    ...
    public OutlineItemViewModelAdapter(IAvnRustViewModel model) : this(model, null, null) { }
    ...
    /// </summary>
    public OutlineItemViewModelAdapter(IAvnRustViewModel model, Action<Action>? dispatch) : this(model, dispatch, null) { }
    ...
    /// batch submission.
    /// </summary>
    public OutlineItemViewModelAdapter(IAvnRustViewModel model, Action<Action>? dispatch, Action<Action>? post)
    {
        _model = model;
        _dispatch = dispatch ?? Dispatch;
        _post = post;
        _batch = new RustVmBatchCoordinator(this, post);
        GoToCommand = new DelegateCommand(parameter => Check(_model.Execute(1, null)));
        try
        {
    ...
    public BatchObservableCollection<global::PdfViewer.Presentation.Generated.OutlineItemViewModelAdapter> Children { get; } = [];
    ...
    public int SetString(int propertyId, string? value)
    {
        ...
        return propertyId switch
        {
            ...
            2 => Apply(() => { var converted = value ?? ""; _inboundWrites.CommitPublication(propertyId, inbound); if (!Equals(_pageLabel, converted)) SetField(ref _pageLabel, converted, nameof(PageLabel)); }),
    ...
    {
        1 => model is null ? unchecked((int)0x80070057) : Apply(() => Children.Add(new global::PdfViewer.Presentation.Generated.OutlineItemViewModelAdapter(model, _dispatch, _post))),
        _ => unchecked((int)0x80070057),
    };
    ...
    {
        1 => model is null ? unchecked((int)0x80070057) : Apply(() => { if ((uint)index > (uint)Children.Count) return unchecked((int)0x80070057); Children.Insert(index, new global::PdfViewer.Presentation.Generated.OutlineItemViewModelAdapter(model, _dispatch, _post)); return 0; }),
        _ => unchecked((int)0x80070057),
    };
    ...
    public int ReplaceModel(int collectionId, int index, IAvnRustViewModel? model) => collectionId switch
    {
        1 => model is null ? unchecked((int)0x80070057) : Apply(() =>
        {
            ...
            Children[index] = new global::PdfViewer.Presentation.Generated.OutlineItemViewModelAdapter(model, _dispatch, _post);
            previous.Dispose();
            return 0;
        }),
        _ => unchecked((int)0x80070057),
    ...
    {
        1 => Apply(() => GoToCommand.SetEnabled(enabled != 0)),
        _ => unchecked((int)0x80070057),
    };
    ...
    public int SetPropertyError(int propertyId, string? message) => propertyId switch
    {
        ...
        2 => Apply(() => SetError(nameof(PageLabel), message)),
    ...
    bool IRustVmBatchTarget.TryGetProperty(int propertyId, out RustVmBatchProperty property)
    {
        property = propertyId switch
        {
            ...
            2 => new RustVmBatchProperty(nameof(PageLabel), RustVmValueWireKind.String, false, false),
    ...
    {
        1 => new global::PdfViewer.Presentation.Generated.OutlineItemViewModelAdapter(model, _dispatch, _post),
