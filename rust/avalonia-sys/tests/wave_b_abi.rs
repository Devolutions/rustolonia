...
fn wave_b_interfaces_publish_abi_version_one_and_nothing_else_moved() {
    for expected in [
        ...
        "#define I_AVN_MENU_BASE_ABI_VERSION 14",
        "#define I_AVN_MENU_ABI_VERSION 14",
        "#define I_AVN_MENU_ITEM_ABI_VERSION 17",
        "#define I_AVN_HEADERED_SELECTING_ITEMS_CONTROL_ABI_VERSION 14",
        "#define I_AVN_SPLIT_VIEW_ABI_VERSION 11",
        "#define I_AVN_DATE_PICKER_ABI_VERSION 13",
        "#define I_AVN_TIME_PICKER_ABI_VERSION 13",
        ...
        "#define I_AVN_HEADERED_ITEMS_CONTROL_ABI_VERSION 14",
        "#define I_AVN_TREE_VIEW_ABI_VERSION 14",
    ] {
        assert!(HEADER.contains(expected), "header is missing `{expected}`");
    }
}
...
fn wave_b_iids_are_fresh_and_distinct_from_every_shipped_one() {
    ...
    for (name, expected, current) in [
        ...
        (
            "IAvnItemsControl",
            "45705E13-A906-50E2-A0D8-DCC20585FDA6",
            I_AVN_ITEMS_CONTROL_IID,
        ),
        (
            "IAvnSelectingItemsControl",
            "18B99B99-03A3-5C68-8471-D463C4ED1778",
